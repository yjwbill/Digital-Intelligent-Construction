...
function queryEconomyWarningNoticeFilters(){economyWarningNoticeState.phone=document.getElementById("economyNoticePhone")?.value.trim()||"";economyWarningNoticeState.name=document.getElementById("economyNoticeName")?.value.trim()||"";economyWarningNoticeState.department=document.getElementById("economyNoticeDepartment")?.value||"";economyWarningNoticeState.post=document.getElementById("economyNoticePost")?.value||"";economyWarningNoticeState.source=document.getElementById("economyNoticeSource")?.value||"";economyWarningNoticeState.status=document.getElementById("economyNoticeStatus")?.value||"";renderEconomyWarningNoticePage();}
