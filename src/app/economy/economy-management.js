...
function getEconomyManagementFilteredRows(){
  ...
  return economyManagementRows.filter(row=>row.status===state.tab
    ...
    &&(state.tab!=="pending"||!state.branch||row.branch.includes(state.branch))
...
function renderEconomyManagementManagedTable(rows){
  const header=`<tr><th class="table-sticky-left economy-management-sequence-column">序号</th><th class="table-sticky-left table-sticky-left-edge economy-management-name-column">项目名称</th><th class="table-sticky-left economy-management-code-column">项目编号</th><th style="width:130px">项目状态</th><th style="width:140px">子公司</th><th style="width:180px">分公司</th><th style="width:190px">项目经理</th><th style="width:160px">项目造价（元）</th><th style="width:140px">立项完成日期</th><th style="width:150px">订单项目编号</th><th style="width:140px">中标价（元）</th><th style="width:130px">中标日期</th><th style="width:190px">建设单位</th><th style="width:120px">开项批次</th><th style="width:120px">上线批次</th><th style="width:150px">EAS编号</th><th style="width:170px">内部分包EAS编号</th><th style="width:130px">子公司编号</th><th style="width:130px">分包模式</th><th style="width:130px">合作模式</th><th style="width:150px">是否类投资项目</th><th style="width:130px">是否投资项目</th><th style="width:180px">纳入全面预算</th><th class="table-sticky-operation economy-management-operation-column">操作</th></tr>`;
...
function renderEconomyManagementPendingTable(rows){
  const header=`<tr><th class="table-sticky-left economy-management-sequence-column">序号</th><th class="table-sticky-left table-sticky-left-edge economy-management-name-column">项目名称</th><th class="table-sticky-left economy-management-code-column">项目编号</th><th style="width:130px">项目状态</th><th style="width:140px">子公司</th><th style="width:180px">分公司</th><th style="width:190px">项目经理</th><th style="width:160px">项目造价（元）</th><th style="width:140px">立项完成日期</th><th style="width:150px">订单项目编号</th><th style="width:140px">中标价（元）</th><th style="width:130px">中标日期</th><th style="width:190px">建设单位</th><th style="width:120px">开项批次</th><th class="table-sticky-operation economy-management-operation-column">操作</th></tr>`;
