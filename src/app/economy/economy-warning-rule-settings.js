...
function renderEconomyWarningRuleSettingsPage(){
  ...
  const columns=["选择","序号","规则编号","规则名称","预警类型","启用状态","备注","操作"];
  mountEconomyCustomColumnSettingButton("warningRule",columns,".economy-warning-rule-content",".economy-rule-table","renderEconomyWarningRuleSettingsPage");
}
