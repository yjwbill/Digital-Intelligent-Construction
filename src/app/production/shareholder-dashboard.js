...
(function(){
  ...
  function economicOverview(){
    ...
    const typeNames=["市政工程","建筑工程","公路工程","轨道交通","水利工程","其他工程"];
